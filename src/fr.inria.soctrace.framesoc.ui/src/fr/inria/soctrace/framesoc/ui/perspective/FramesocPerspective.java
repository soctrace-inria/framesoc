...
public class FramesocPerspective implements IPerspectiveFactory {
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		// Top left folder
		IFolderLayout topLeftFolder = layout.createFolder(TOP_LEFT, IPageLayout.LEFT, 0.25f,
		...
		// Bottom left folder
		IFolderLayout bottomLeftFolder = layout.createFolder(BOTTOM_LEFT, IPageLayout.BOTTOM,
				0.45f, TOP_LEFT);
		...
		// Top right folder
		IFolderLayout topRightFolder = layout.createFolder(TOP_RIGHT, IPageLayout.TOP, 0.75f,
				IPageLayout.ID_EDITOR_AREA);
		...
		// Bottom right folder
		IFolderLayout middleRightFolder = layout.createFolder(BOTTOM_RIGHT, IPageLayout.BOTTOM,
				0.45f, TOP_RIGHT);
	...
	private void debug(IPageLayout layout) {
		...
		Display.getDefault().asyncExec(new Runnable() {
			@Override
			public void run() {
				FramesocPartManager.getInstance().getPartInstance(FramesocViews.DEBUG_VIEW_ID,
						null, false);
			}
		});
	}
