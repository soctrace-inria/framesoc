 ...
 */
public class CopyOfDefaultImporterInputComposite extends AbstractToolInputComposite {

	protected FileInputComposite traceFiles;
	protected LaunchTextListener traceFileListener;

	public CopyOfDefaultImporterInputComposite(Composite parent, int style) {
		super(parent, style);
		...
		Button btnNewButton = new Button(traceFiles, SWT.NONE);
		btnNewButton.setText("New Button");
		new Label(traceFiles, SWT.NONE);
		new Label(traceFiles, SWT.NONE);
		
		Button btnNewButton_1 = new Button(traceFiles, SWT.NONE);
		btnNewButton_1.setText("New Button");
		new Label(traceFiles, SWT.NONE);
		new Label(traceFiles, SWT.NONE);
		
		Button btnNewButton_2 = new Button(traceFiles, SWT.NONE);
