...
public class ConfigurationDialog extends Dialog {
	...
	private Map<Long, Tool> loadTools() {
		Map<Long, Tool> toolsMap = new HashMap<Long, Tool>();
	...
	public Map<Long, Tool> getOldTools() {
		return oldTools;
	}

	public void setOldTools(Map<Long, Tool> oldTools) {
