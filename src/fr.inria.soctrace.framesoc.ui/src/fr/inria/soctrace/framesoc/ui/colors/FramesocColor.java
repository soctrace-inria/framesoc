 ...
 * 
 * <p>
 * Internally both an SWT and an AWT colors are used.
 * Both color objects are lazily initialized on demand, 
 * based on the RGB description of the color.
 * 
 * <p>
 * Disposing an object of this class, dispose all the 
 * lazily initialized internal color objects.
 * 
...
public class FramesocColor {
	...
	/**
	 * Get the SWT color corresponding to the RGB triplet.
	 * The SWT color is lazily initialized.
	...
	/**
	 * Get the AWT color corresponding to the RGB triplet.
	 * The AWT color is lazily initialized.
