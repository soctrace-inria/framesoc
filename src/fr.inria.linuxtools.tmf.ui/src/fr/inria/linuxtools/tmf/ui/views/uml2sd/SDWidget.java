...
import fr.inria.linuxtools.tmf.ui.views.uml2sd.core.BasicExecutionOccurrence;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.core.Frame;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.core.GraphNode;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.core.ITimeRange;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.core.Lifeline;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.core.Metrics;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.dialogs.SDPrintDialog;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.dialogs.SDPrintDialogUI;
...
public class SDWidget extends ScrollView implements SelectionListener,
    ...
    public void setSite(ViewPart viewSite) {
        ...
        IContextService service = fSite.getSite().getWorkbenchWindow().getService(IContextService.class);
