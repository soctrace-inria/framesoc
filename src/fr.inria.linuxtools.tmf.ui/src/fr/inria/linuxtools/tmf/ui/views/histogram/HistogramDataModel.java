...
public class HistogramDataModel implements IHistogramDataModel {
     ...
     *
     * @see fr.inria.linuxtools.tmf.ui.views.distribution.model.IBaseDistributionModel#clear()
     */
    @Override
    public void clear() {
     ...
     *
     * @see fr.inria.linuxtools.tmf.ui.views.histogram.IHistogramDataModel#scaleTo(int,
     *      int, int)
     */
    @Override
