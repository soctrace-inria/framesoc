...
public class KeyBindingsManager {
    ...
    private void initialize() {
        ...
        IHandlerService service = PlatformUI.getWorkbench().getActiveWorkbenchWindow().getService(IHandlerService.class);
        ...
        fShowNodeStartForKeyBinding.setId("fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.ShowNodeStart");//$NON-NLS-1$
        fShowNodeStartForKeyBinding.setActionDefinitionId("fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.ShowNodeStart");//$NON-NLS-1$
        ...
        fShowNodeEndForKeyBinding.setId("fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.ShowNodeEnd");//$NON-NLS-1$
        fShowNodeEndForKeyBinding.setActionDefinitionId("fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.ShowNodeEnd");//$NON-NLS-1$
