...
import fr.inria.linuxtools.tmf.ui.views.uml2sd.dialogs.SearchFilterDialog;
...
public class OpenSDFindDialog extends BaseSDAction {
     ...
     * The action ID.
     */
    public static final String ID = "fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.sdFind"; //$NON-NLS-1$
