...
import fr.inria.linuxtools.tmf.ui.project.wizards.NewTmfProjectWizard;
import fr.inria.linuxtools.tmf.ui.views.histogram.HistogramView;
import fr.inria.linuxtools.tmf.ui.views.statistics.TmfStatisticsView;
...
public class TracingPerspectiveFactory implements IPerspectiveFactory {
    ...
    /** The Perspective ID */
    public static final String ID = "fr.inria.linuxtools.tmf.ui.perspective"; //$NON-NLS-1$
