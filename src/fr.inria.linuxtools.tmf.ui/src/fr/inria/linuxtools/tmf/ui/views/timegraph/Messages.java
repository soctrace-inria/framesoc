...
package fr.inria.linuxtools.tmf.ui.views.timegraph;
...
public class Messages extends NLS {
    private static final String BUNDLE_NAME = "fr.inria.linuxtools.tmf.ui.views.timegraph.messages"; //$NON-NLS-1$
