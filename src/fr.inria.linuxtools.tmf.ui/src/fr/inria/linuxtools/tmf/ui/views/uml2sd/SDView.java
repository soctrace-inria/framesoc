...
package fr.inria.linuxtools.tmf.ui.views.uml2sd;
...
import fr.inria.linuxtools.tmf.ui.views.uml2sd.core.BaseMessage;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.core.Frame;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.core.GraphNode;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.core.SyncMessage;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.core.SyncMessageReturn;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.ConfigureMinMax;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.FirstPage;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.KeyBindingsManager;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.LastPage;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.MoveToMessage;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.NextPage;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.OpenSDFiltersDialog;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.OpenSDFindDialog;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.OpenSDPagesDialog;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.PrevPage;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.Print;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.ShowNodeEnd;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.ShowNodeStart;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.Zoom;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.Zoom.ZoomType;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.provider.IExtendedFilterProvider;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.provider.IExtendedFindProvider;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.provider.ISDAdvancedPagingProvider;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.provider.ISDCollapseProvider;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.provider.ISDExtendedActionBarProvider;
...
import fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.provider.ISDPagingProvider;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.provider.ISDPropertiesProvider;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.load.IUml2SDLoader;
import fr.inria.linuxtools.tmf.ui.views.uml2sd.load.LoadersManager;
...
public class SDView extends ViewPart {
    ...
    protected void setFrame(Frame frame, boolean resetPosition) {
        ...
        IContributionItem shortKeysMenu = getViewSite().getActionBars().getMenuManager().find("fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers");//$NON-NLS-1$
