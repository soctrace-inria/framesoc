...
public class Zoom extends BaseSDAction {
     ...
     */
    public static final String ZOOM_IN_ID = "fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.ZoomInCoolBar"; //$NON-NLS-1$
    /**
     * The Action ID for zooming out.
     */
    public static final String ZOOM_OUT_ID = "fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.ZoomOutCoolBar"; //$NON-NLS-1$
    /**
     * The Action ID for reset zooming.
     */
    public static final String RESET_ZOOM_ID = "fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.ResetZoom"; //$NON-NLS-1$
    /**
     * The Action ID for no zoominf.
     */
    public static final String NO_ZOOM_ID = "fr.inria.linuxtools.tmf.ui.views.uml2sd.handlers.NoZoom"; //$NON-NLS-1$
