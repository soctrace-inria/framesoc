...
import fr.inria.linuxtools.tmf.ui.viewers.events.TmfEventAdapterFactory;
...
public class Activator extends AbstractUIPlugin {
     ...
     * The plug-in ID
     */
    public static final String PLUGIN_ID = "fr.inria.linuxtools.tmf.ui"; //$NON-NLS-1$
    /**
     * The core plug-in ID
     */
    public static final String PLUGIN_CORE_ID = "fr.inria.linuxtools.tmf.core"; //$NON-NLS-1$
