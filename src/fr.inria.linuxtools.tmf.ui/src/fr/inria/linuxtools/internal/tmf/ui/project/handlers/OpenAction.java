...
import fr.inria.linuxtools.tmf.ui.project.model.TmfAnalysisOutputElement;
import fr.inria.linuxtools.tmf.ui.project.model.TmfExperimentElement;
import fr.inria.linuxtools.tmf.ui.project.model.TmfProjectModelElement;
...
public class OpenAction extends Action {
    ...
    public void run() {
        try {
            IHandlerService handlerService = page.getActivePart().getSite().getService(IHandlerService.class);
