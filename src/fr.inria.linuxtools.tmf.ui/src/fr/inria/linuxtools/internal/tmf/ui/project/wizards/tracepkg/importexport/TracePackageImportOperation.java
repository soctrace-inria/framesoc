...
import fr.inria.linuxtools.internal.tmf.ui.project.wizards.tracepkg.TracePackageBookmarkElement;
...
import fr.inria.linuxtools.internal.tmf.ui.project.wizards.tracepkg.TracePackageSupplFileElement;
import fr.inria.linuxtools.internal.tmf.ui.project.wizards.tracepkg.TracePackageSupplFilesElement;
...
public class TracePackageImportOperation extends AbstractTracePackageOperation implements IOverwriteQuery {
        ...
        for (TracePackageElement packageElement : fImportTraceElements) {
            ...
            if (existingTrace != null) {
                try {
                    ...
                    return new Status(IStatus.ERROR, Activator.PLUGIN_ID, fr.inria.linuxtools.internal.tmf.ui.project.wizards.tracepkg.Messages.TracePackage_ErrorOperation, e);
                }
            }
        }
    ...
    private IStatus importFiles(ArchiveFile archiveFile, List<Pair<String, String>> fileNameAndLabelPairs, IPath destinationContainerPath, IPath baseSourcePath, IProgressMonitor monitor) {
        ...
        if (provider.getException() != null) {
            return new Status(IStatus.ERROR, Activator.PLUGIN_ID, fr.inria.linuxtools.internal.tmf.ui.project.wizards.tracepkg.Messages.TracePackage_ErrorOperation, provider.getException());
        }
