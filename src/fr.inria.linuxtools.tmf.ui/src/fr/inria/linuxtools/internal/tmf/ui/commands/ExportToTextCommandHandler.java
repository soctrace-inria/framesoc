...
public class ExportToTextCommandHandler extends AbstractHandler {
    ...
    public static final String COMMAND_ID = "fr.inria.linuxtools.tmf.ui.exportToText"; //$NON-NLS-1$
    /**
     ...
     */
    public static final String TMF_EVENT_TABLE_PARAMETER_ID = "fr.inria.linuxtools.tmf.ui.exportToText.table"; //$NON-NLS-1$
    /**
     ...
     */
    public static final String TMF_EVENT_TABLE_HEADER_ID = "fr.inria.linuxtools.tmf.ui.exportToText.header"; //$NON-NLS-1$
