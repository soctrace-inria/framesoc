...
package fr.inria.linuxtools.internal.tmf.ui.project.wizards.tracepkg;
...
abstract public class AbstractTracePackageWizardPage extends WizardPage {
    ...
    protected void createFilePathGroup(Composite parent, String label, final int fileDialogStyle) {
        ...
        fBrowseButton = new Button(filePathSelectionGroup,
                SWT.PUSH);
        fBrowseButton.setText(fr.inria.linuxtools.internal.tmf.ui.project.wizards.tracepkg.Messages.TracePackage_Browse);
    ...
    protected Composite createButtonsGroup(Composite parent) {
        ...
        fSelectAllButton.setText(fr.inria.linuxtools.internal.tmf.ui.project.wizards.tracepkg.Messages.TracePackage_SelectAll);
        ...
        fDeselectAllButton.setText(fr.inria.linuxtools.internal.tmf.ui.project.wizards.tracepkg.Messages.TracePackage_DeselectAll);
    ...
    protected void handleErrorStatus(IStatus status) {
        ...
        String message = status.getMessage().length() > 0 ? status.getMessage() : fr.inria.linuxtools.internal.tmf.ui.project.wizards.tracepkg.Messages.TracePackage_ErrorOperation;
        ...
        final Status statusWithException = new Status(IStatus.ERROR, Activator.PLUGIN_ID, IStatus.ERROR, fr.inria.linuxtools.internal.tmf.ui.project.wizards.tracepkg.Messages.TracePackage_ErrorMultipleProblems, exception);

        Activator.getDefault().logError(message, exception);
        ErrorDialog.openError(getContainer().getShell(), fr.inria.linuxtools.internal.tmf.ui.project.wizards.tracepkg.Messages.TracePackage_InternalErrorTitle, message, statusWithException);
    }
    ...
    private void displayErrorDialog(String message, Throwable exception) {
        if (exception == null) {
            ...
            ErrorDialog.openError(getContainer().getShell(), fr.inria.linuxtools.internal.tmf.ui.project.wizards.tracepkg.Messages.TracePackage_InternalErrorTitle, null, s);
            return;
        }
        ...
        ErrorDialog.openError(getContainer().getShell(), fr.inria.linuxtools.internal.tmf.ui.project.wizards.tracepkg.Messages.TracePackage_InternalErrorTitle, message, s);
    }
