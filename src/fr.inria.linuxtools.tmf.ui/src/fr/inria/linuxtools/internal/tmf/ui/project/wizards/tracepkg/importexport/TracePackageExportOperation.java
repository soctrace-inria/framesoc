...
import fr.inria.linuxtools.internal.tmf.ui.project.wizards.tracepkg.ITracePackageConstants;
    ...
    public void run(IProgressMonitor progressMonitor) {
        ...
        try {
            ...
            if (e instanceof InterruptedException) {
                ...
                setStatus(new Status(IStatus.ERROR, Activator.PLUGIN_ID, fr.inria.linuxtools.internal.tmf.ui.project.wizards.tracepkg.Messages.TracePackage_ErrorOperation, e));
            }
        }
    }
