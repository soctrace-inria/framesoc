...
import fr.inria.linuxtools.internal.tmf.core.statesystem.backends.partial.PartialHistoryBackend;
import fr.inria.linuxtools.internal.tmf.core.statesystem.backends.partial.PartialStateSystem;
...
import fr.inria.linuxtools.statesystem.core.StateSystemFactory;
import fr.inria.linuxtools.statesystem.core.backend.IStateHistoryBackend;
import fr.inria.linuxtools.statesystem.core.backend.InMemoryBackend;
import fr.inria.linuxtools.statesystem.core.backend.NullBackend;
import fr.inria.linuxtools.statesystem.core.backend.historytree.HistoryTreeBackend;
import fr.inria.linuxtools.statesystem.core.backend.historytree.ThreadedHistoryTreeBackend;
...
public abstract class TmfStateSystemAnalysisModule extends TmfAbstractAnalysisModule
     ...
     *
     * @param id
     *            The ID of the statesystem. It should be unique
     * @param provider
     *            The state provider
     * @param htFile
     *            Filename/location of the history we want to load
     * @throws TmfTraceException
     *             when an erros occurs while opening the file
     * @Framesoc
     */
    ...
    private void createPartialHistory(String id, ITmfStateProvider provider, File htPartialFile)
        ...
        fr.inria.linuxtools.internal.statesystem.core.StateSystem realSS =
        (fr.inria.linuxtools.internal.statesystem.core.StateSystem) StateSystemFactory.newStateSystem(id, partialBackend);
