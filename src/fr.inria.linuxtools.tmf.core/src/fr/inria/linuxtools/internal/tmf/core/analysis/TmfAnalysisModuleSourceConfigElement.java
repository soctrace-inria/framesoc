...
package fr.inria.linuxtools.internal.tmf.core.analysis;
...
import fr.inria.linuxtools.tmf.core.analysis.IAnalysisModuleSource;
import fr.inria.linuxtools.tmf.core.analysis.TmfAnalysisModuleHelperConfigElement;
...
public final class TmfAnalysisModuleSourceConfigElement implements IAnalysisModuleSource {
    ...
    /** Extension point ID */
    public static final String TMF_ANALYSIS_TYPE_ID = "fr.inria.linuxtools.tmf.core.analysis"; //$NON-NLS-1$
