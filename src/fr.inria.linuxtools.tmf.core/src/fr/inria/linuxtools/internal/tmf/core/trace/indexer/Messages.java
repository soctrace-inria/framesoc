...
package fr.inria.linuxtools.internal.tmf.core.trace.indexer;
...
public class Messages extends NLS {
    private static final String BUNDLE_NAME = "fr.inria.linuxtools.internal.tmf.core.trace.indexer.messages"; //$NON-NLS-1$
    /**
     * Error opening index
     */
